...
public class PhaseOne 
{
	...
	public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException 
	{
	    ...
	    {
		String tempStr1 = docPart[i].replaceAll("\\p{P}", ""); //removing special character and punctuation from the word
		String tempStr2 = docPart[i+1].replaceAll("\\p{P}","");
		tempStr = tempStr1+"_"+tempStr2+","+docName;
